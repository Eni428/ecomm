...
session_start();
// Merr ID-në e adminit nga sesioni
$admin_id = $_SESSION['admin_name'];

if (!isset($admin_id)) {
// Nëse nuk ka admin të kyçur, ridrejtohet te login.php
   header('location:login.php');
}

if(isset($_POST['logout'])) {
// Butoni i logout, shkatërron sesionin dhe ridrejton tek login.php
   session_destroy();
   header('location:login.php');
}
?>
   ...
   <section class="dashboard">
      <div class="box-container">
         <div class="box">
            ...
            while ($fetch_pending = mysqli_fetch_assoc($select_pendings)) { //merr rreshtin e pergjigjes
